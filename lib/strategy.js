...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://restapi.actonsoftware.com/authorize?scope=PRODUCTION&amp;response_type=code&amp;client_id='+options.clientID;
  options.tokenURL = options.tokenURL || 'https://restapi.actonsoftware.com/token';
